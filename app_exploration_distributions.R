...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("bY_A", "bY_A", value = 1),
      numericInput("bY_B", "bY_B", value = 1),
      numericInput("bY_C", "bY_C", value = 0),
      numericInput("fbT", "fbT", value = 1),
      numericInput("bT", "bT", value = 0.5),
      numericInput("bT_X1", "bT_X1", value = 1),
      numericInput("bT2_X1", "bT2_X1", value = -0.5),
      numericInput("bT_X2", "bT_X2", value = 1),
      numericInput("bT2_X2", "bT2_X2", value = -0.5),
      numericInput("bY_X1", "bY_X1", value = 1),
      numericInput("bY_X2", "bY_X2", value = 2),
      numericInput("bY_A_X1", "bY_A_X1", value = 2),
